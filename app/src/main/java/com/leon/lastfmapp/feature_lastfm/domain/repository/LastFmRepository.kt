...
interface LastFmRepository
{
    ...
    suspend fun getArtistInfo(artistName: String, cacheDuration: Int): Resource<ArtistInfo>
    
    suspend fun getArtistTopTracks(artistName: String, cacheDuration: Int): Resource<ArtistTopTracks>
